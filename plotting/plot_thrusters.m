...
%%
subplot(313);
plot(t, rad2deg(alpha_thr.Data(:, 3)), 'linewidth', 2); hold on;
plot(t, rad2deg(alpha_thr.Data(:, 4)), 'linewidth', 2); grid on;
plot(t, rad2deg(alpha_thr.Data(:, 5)), 'linewidth', 2);
